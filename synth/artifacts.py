...
from utils.image import load_tips_from_pkl, normalize, subtract_mean_plane_both
...
class Artifactor():
    ...
    def get_default_param_dict():
        default_params = {
            ...
            # overshoot params
            'overshoot_prob': 0.7, 'max_overshoot_t': 0.5, 'max_overshoot_mag': 0.2, 'min_p_keep': 0.0,
