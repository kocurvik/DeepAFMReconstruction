...
if __name__ == '__main__':
    ...
    art_both = Artifactor(shadows_prob=1.0, noise_prob=0.0, skew_prob=0.0, overshoot_prob=0.0, shadows_uniform_both_p=1.0, shadows_randomize_prob=0.0)
    ...
    while True:
        ...
        img = entry[0]
        img_l_both, img_r_both = art_both.apply(img)
        img_l_single, img_r_single = art_single.apply(img)
        img_l_both_random, img_r_both_random = art_both_random.apply(img)
        img_l_single_random, img_r_single_random = art_single_random.apply(img)
        ...
        #
            cv2.imwrite("figs/shadows/base.png", 255 * img)
