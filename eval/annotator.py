...
from utils.image import load_lr_img_from_gwy
...
def annotate_entries(entries):
    for i, entry in enumerate(entries):
        ...
        if i == 0:
            example_img = cv2.cvtColor(entry['img_l'], cv2.COLOR_GRAY2BGR)
            for pt in clicked:
...
if __name__ == '__main__':
    path = 'D:/Research/data/GEFSEM/2021-04-07 - Dataset/TGZ3'
